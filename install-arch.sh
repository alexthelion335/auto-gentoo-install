...
sleep 1
pacstrap /mnt base linux linux-firmware nano vim sudo base-devel git networkmanager dhcpcd grub xorg-server xf86-video-vesa xorg-xinit neofetch openbox tint2 nitrogen gdm firefox konsole xterm mpv thunar dolphin picom inkscape gimp cmatrix lynx lolcat cowsay
